...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2023 at 09:34 AM
...
--
CREATE DATABASE IF NOT EXISTS `examania_local` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `examania_local`;
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `quesSubject` varchar(200) DEFAULT NULL
