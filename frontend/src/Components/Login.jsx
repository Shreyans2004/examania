...
const Login = () => {
  ...
  return (
    <form>
    <div className="hero_main hero flex1">
      <div className='left'>
      ...
      <div className='right'>
        <div className='div_r_1'>
          ...
          <input name="username" onChange={handleChange} value={formData.username} type="text" className='input_1' placeholder='1234@1234.gmail.com' required></input>
          <img  src="./user_icon.png" alt='user_icon' width={40} height={30}></img>
        </div>
        <div className='div_r_2'>
          <label className='label_1'>Password</label>
          <input name="password" onChange={handleChange} value={formData.password}  type='password'  placeholder='password'  className='input_1' required></input>
